...
You’re now entering the phase of the program where you need make some choices and decide on your future career. As you embark on this adventure, there’s one thing you shouldn’t overlook: making smart and strategic career choices. Yes, I know it might sound daunting, but fear not! We’re here to guide you through the maze of possibilities and help you carve out a path that’s tailor-made for your dreams and aspirations.

Before, we talk about how you can go about making these choices, let’s first dive into why making effective career choices is not just important but absolutely crucial:
...
3. Finding Purpose and Satisfaction: Picture yourself in a career that ignites your passion, challenges your intellect, and leaves you feeling fulfilled at the end of each day. That’s the power of making thoughtful career choices – it’s about finding work that not only pays the bills but also brings meaning and joy to your life.

Now that we’ve established why career choices matter, let’s explore some tips to help you navigate this exciting yet sometimes overwhelming process:

1. Know Thyself: Take the time to reflect on your strengths, weaknesses, interests, and values. What makes you tick? What kind of work energizes you? Understanding yourself is the first step towards making informed career decisions. This is the reason why we asked you to explore your values (remember the stones, pebbles and sand activity you did in week 1?), and why you’re maintaining a skills map.

2. Explore Your Options: The world is brimming with possibilities, so don’t limit yourself to just a handful of career paths. Take advantage of resources shared with you, explore these career options online, and find the right people to conduct informational interviews to explore different industries and roles.

3. Seek Guidance: Don’t be afraid to reach out for help and guidance. Whether it’s chatting with a career counselor, networking with alumni, or seeking advice from peers and community ambassadors, or even getting in touch with the staff at your nearest ALX Hub, there’s a wealth of wisdom waiting to be tapped into.
...
Remember, you’re not alone in this journey. ALX is here to support you every step of the way, providing resources, guidance, and a supportive community to help you thrive. In fact, in this module, we’ll share with you an overview what the programs we offer are about, and what you can expect from them.

So, as you embark on this thrilling adventure, don’t forget to keep one eye on the horizon – your future awaits, and the choices you make today will shape the path ahead. Here’s to a journey filled with growth, discovery, and endless possibilities. Cheers to crafting a career that’s uniquely yours!

# ALX Program: Data Analytics
Let’s start with Data Analytics! Take time to watch these next two videos to learn about Data Analytics and what it entails. As you watch note:
...
📲 Curious about a career in Data Analytics? Book a call with a program advisor: https://bit.ly/47LEBk3
...
If you’re interested in learning more about data analytics, you can check out CareerFoundry’s detailed article on the topic here: http://bit.ly/What_Is_Data_Analytics
...
Data Analytics For Beginners - An Introduction (2021):
   • What Is Data Analytics? - An Introduc...
```
***Transcript***:
```txt
...
What is the data analysis process? What steps are involved, and how do they relate to the wider discipline of data analytics? In this video, we’ll give you a step-by-step guide to the process, detailing each stage and where it fits into a data analyst’s work!
...
In this video, we’ll explore and break down the main steps in the data analysis process. This will cover how to define your goal, collect data, and carry out an analysis. We’ll also use examples and highlight a few tools to make this process easier. This video will equip you with a much better understanding of the basics behind the data analysis process.

For a deeper dive on the data analysis process, you can check out CareerFoundry’s detailed article here: https://bit.ly/TheDataAnalysisProcess

Interested in getting started in data analytics? We also have a fantastic, free short course, to help give you a flavor of what it’s like to work in the field. Sign up here: https://bit.ly/GetStartedInDataAnalytics
...
Data Analytics: The Data Analysis Process (Step-By-Step) 2021
   • A Beginners Guide To The Data Analysi...
```
***Transcript***:
```txt
...
Come on, let’s get comfortable and learn.
...
So how does “data analytics” differ from “data science”? Well…
...
Exciting, right? But before we get too happy about all these opportunities, let’s take a closer look at Salesforce as a service and how it serves organizations.
...
It is the world’s #1 CRM platform, enabling businesses to sell, service, and market like never before and it’s the Customer Success Platform helping you to connect to your customers in a whole new way with SaaS based solutions for Sales, Customer Service, Marketing, Analytics, App Development and the Internet of Things.
...
Now that we know what Salesforce is (and is not) let’s understand more about this acronym: CRM.
***Desorption***
```md
...
Now that you know what CRM is, learn how Salesforce Customer 360, the world’s #1 CRM platform, helps you unite your teams around your customer: https://sfdc.co/JAsr9 #Salesforce #CRM #Customer360
...
In the video that premiered at Dreamforce ‘21, #AwesomeAdmins around the world shared what being an admin means to them!
...
Salesforce+
Here is a link to [Salesforce+](https://www.salesforce.com/plus) a free streaming service for businesses. It’s a place to watch live events and original series that help you grow your career on your own time. Everything is free and unlimited.
...
🔥AWS Cloud Architect Masters Program (Discount Code - YTBE15) - https://www.simplilearn.com/aws-cloud...
🔥IITK - Professional Certificate Program in Cloud Computing and DevOps (India Only)  - https://www.simplilearn.com/cloud-com...
...
⏩ Check out the AWS(Amazon web services) training videos: https://bit.ly/2LtnprE
...
Now we know all about Clouding Computing and AWS let’s preempt two follow on questions you might have:
...
Salesforce associate bootcamp (FREE) -    • Salesforce Associate Program | FREE B...
Salesforce genie -    • Salesforce unveils Genie CDP | saasguru
Salesforce PD1 exam guide -    • Salesforce Platform Developer 1 Exam ...
Webinar list -    • Three effective ways to prepare for a...

-------------------------------------------------------
🎁🎁🎁 Use code "TUBE20" to get a 20% discount on saasguru's Courses.
Saasguru courses - https://www.saasguru.co/salesforce-on... 🎁🎁🎁
...
Lucy here! 👋 I've been working as an Associate Solutions Architect at AWS for 1 year, and in this video I talk about:
...
▬▬▬▬ 📚 My Courses ▬▬▬▬
• AWS Interview Mastery ["YOUTUBE10" for 10% off]: https://learn.techwithlucy.com/p/aws-...
• 5 Beginner AWS Cloud Projects ["YOUTUBE10" for 10% off]: https://learn.techwithlucy.com/p/5-be...

▬▬▬▬ Links to Recommended Resources ▬▬▬▬
• Zero-to-Mastery Cloud Course: https://academy.zerotomastery.io/a/af...
• Zero-to-Mastery Solutions Architect Course: https://academy.zerotomastery.io/a/af...

▬▬▬▬ New to the "Tech With Lucy"? ⬇️  ▬▬▬▬
• 📸 Follow me on Instagram -   / techwithlucy
• 👩‍💻 50K+ Community on LinkedIn  -   / lucywang-
• 🗞 My Free Cloudbites.ai E-Newsletter: https://www.cloudbites.ai/subscribe

Thanks for watching - make sure you also take a look at my other videos! 😊
```
***Transcript***:
```txt
